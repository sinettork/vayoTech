...
<div class="bg-dark text-white p-4 mb-4 d-flex align-items-center justify-content-between gap-4">
    ...
    <div class="d-flex align-items-center gap-3">
        ...
        @if($brand->brandfetch_logo_url)
            <img
                ...
                width="64"
                height="64"
                style="object-fit:contain;background:#fff;padding:8px;"
            >
        @elseif($brand->logo)
            <img
        ...
        <div>
            ...
            <p class="mb-0 text-white-50">
                {{ $deviceCount }} {{ Str::plural('device', $deviceCount) }} listed
            </p>
        </div>
